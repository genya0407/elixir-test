...
var _user$project$Main$viewState = function (state) {
	return A2(
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(state.name),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(state.message),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _user$project$Main$jsonToOnlineCount = function (str) {
	var _p0 = A2(
		_elm_lang$core$Json_Decode$decodeString,
		A2(_elm_lang$core$Json_Decode$field, 'online_count', _elm_lang$core$Json_Decode$int),
		str);
	if (_p0.ctor === 'Ok') {
		return _elm_lang$core$Maybe$Just(_p0._0);
	} else {
...
var _user$project$Main$jsonToState = function (str) {
	var messageRes = A2(
		_elm_lang$core$Json_Decode$decodeString,
	...
	var nameRes = A2(
		...
		str);
	var _p1 = {ctor: '_Tuple2', _0: nameRes, _1: messageRes};
	if (((_p1.ctor === '_Tuple2') && (_p1._0.ctor === 'Ok')) && (_p1._1.ctor === 'Ok')) {
		return _elm_lang$core$Maybe$Just(
			{name: _p1._0._0, message: _p1._1._0});
	} else {
		return _elm_lang$core$Maybe$Nothing;
	}
};
var _user$project$Main$stateToJson = function (state) {
	return A2(
		...
		_elm_lang$core$Json_Encode$object(
			{
				...
				_1: {
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'message',
						_1: _elm_lang$core$Json_Encode$string(state.message)
					},
					_1: {ctor: '[]'}
				}
			}));
};
var _user$project$Main$echoServer = 'ws://localhost:5000/';
			...
			case 'Send':
				return {
					...
					_1: A2(
						...
						_user$project$Main$echoServer,
						_user$project$Main$stateToJson(
							{name: model.name, message: model.input}))
				};
			case 'NewState':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							states: {ctor: '::', _0: _p2._0, _1: model.states}
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'NewOnlineCount':
...
var _user$project$Main$Model = F4(
	function (a, b, c, d) {
		return {name: a, input: b, states: c, onlineCount: d};
	});
...
var _user$project$Main$Pass = {ctor: 'Pass'};
var _user$project$Main$NewOnlineCount = function (a) {
	return {ctor: 'NewOnlineCount', _0: a};
};
var _user$project$Main$NewState = function (a) {
	return {ctor: 'NewState', _0: a};
};
var _user$project$Main$jsonToMsg = function (str) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		A2(
			_elm_lang$core$Maybe$withDefault,
			_user$project$Main$Pass,
			A2(
				_elm_lang$core$Maybe$map,
				_user$project$Main$NewOnlineCount,
				_user$project$Main$jsonToOnlineCount(str))),
		A2(
			_elm_lang$core$Maybe$map,
			_user$project$Main$NewState,
			_user$project$Main$jsonToState(str)));
};
var _user$project$Main$subscriptions = function (model) {
	return A2(_elm_lang$websocket$WebSocket$listen, _user$project$Main$echoServer, _user$project$Main$jsonToMsg);
};
...
var _user$project$Main$onEnter = function (msg) {
	return A2(
		...
		A2(
			_elm_lang$core$Json_Decode$map,
			function (c) {
				return _elm_lang$core$Native_Utils.eq(c, 13) ? _user$project$Main$Send : _user$project$Main$Pass;
			},
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						A2(
							_elm_lang$core$List$map,
							_user$project$Main$viewState,
							_elm_lang$core$List$reverse(model.states))),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
								...
								},
								{
									...
									_0: A2(
										_elm_lang$html$Html$input,
										{
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: _user$project$Main$onEnter(_user$project$Main$Send),
													_1: {
														ctor: '::',
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$for('message'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
